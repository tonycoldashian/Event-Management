...
<form action="customer_view.php" method="POST">
    ...
    <nav class="w3-bar w3-black">
     ...
     <a href="http://localhost/event/payment.html" class="w3-button w3-bar-item">Payment</a>
...
<table>
 ...
 <table>
    ...
    <tr>
       ...
       <td><?php echo $row["plates_number"]; ?></td>
    </tr>
    <?php
    $i++;
 }
...
<table>
    ...
    <tr>
    <td><?php echo $row["travel_charges"]; ?></td> 
...
if(isset($_POST['change']))
{
   ...
   $cid=$_POST['custid'];
   $changequery= "UPDATE customer1 SET c_password = '$newpass' WHERE  c_username = '$usrname' and c_id='$cid';";
...
<label for="psw"><b> Customer ID </b></label>
 <input type="text" placeholder="Enter customer ID " name="custid">
 <br>
